...
// generate a SIMD 128bit vector filled with given unsigned char
__m128i fill(unsigned char c) {
	return _mm_setr_epi8(c, c, c, c, c, c, c, c,
			c, c, c, c, c, c, c, c);
}
...
void run_memset_128() {
	memset_128(buf1, fill('c'), buf_size);
}
